...
Revision ID: 03d045d1db94
Revises: 
Create Date: 2026-02-16 22:51:33.374087
...
def upgrade() -> None:
    ...
    sa.Column('observations_count_rg', sa.Integer(), nullable=True),
    ...
    sa.Column('wikipedia_summary', sa.String(), nullable=True),
    ...
    sa.Column('identifications_count', sa.Integer(), nullable=True),
    ...
    sa.Column('identifications', sa.JSON(), nullable=True),
    sa.Column('ofvs', sa.JSON(), nullable=True),
    ...
    op.create_index(op.f('ix_observation_observed_on'), 'observation', ['observed_on'], unique=False)
    op.create_index(op.f('ix_observation_quality_grade'), 'observation', ['quality_grade'], unique=False)
